...
export const UserConfigForm: React.FC<UserConfigFormProps> = ({
  ...
  // Tier0 fork renders only AiConfig; keep upstream settings UI referenced
  // so future upstream merges stay conflict-free.
  void [renderBody, configMessage, marimoVersion, locale];
